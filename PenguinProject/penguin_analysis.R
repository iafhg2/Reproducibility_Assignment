...
##     b) Runs an ANOVA to test whether culmen (bill) length differs significantly between species
##     c) Plots histograms displaying the variation in bill length in each species
##     d) Saves plot
##
## Author: ANONYMOUS
##
...
# Set the working directory to the downloaded folder "PenguinProject".
...
# Finally, save session information:
