...
##
## Purpose of script: definefunctions to clean data
##
## Author: ANONYMOUS
##
...
# 'correct_Adelie' function: decapitalises the 'Penguin' in Adelie Penguin, so that it is lowercase like in the other species:
